...
const completeChecklist: ProcessChecklist = {
  ...
  drivingLicencePhotographed: true,
...
const pxSarah: PartExchangeRecord = {
  ...
  equity: -2200,
  serviceHistoryType: "fsh",
  servicedWhere: "main-dealer",
  v5InSellersName: "yes",
  keyCount: "2",
  insuranceWriteOff: "no",
  accidentHistory: "no",
  valueDrivers: ["parking-sensors", "reversing-camera", "sat-nav", "leather-seats"],
};
...
const pxDavid: PartExchangeRecord = {
  ...
  equity: -700,
  serviceHistoryType: "psh",
  servicedWhere: "independent",
  v5InSellersName: "yes",
  keyCount: "1",
  insuranceWriteOff: "no",
  accidentHistory: "no",
